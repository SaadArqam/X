          ...
          <aside className="w-[280px] hidden xl:block border-r border-[#111111] bg-newsprint">
            <div className="sticky top-[60px] p-6">
              <div className="border border-[#111111] sharp-corners bg-white p-5 hard-shadow-hover relative group">
                <h3 className="font-sans font-bold uppercase tracking-widest text-ink text-sm mb-4 border-b border-[#111111] pb-2 flex items-center">
                   <span className="mr-2 text-editorial italic">✦</span> Trending Keywords
                </h3>
                {[
                  { tag: '#React', count: 8.4 },
                  ...
                  <div key={tag} className="mb-3 flex justify-between items-center group/tag border-b border-dashed border-divider pb-2 last:border-0 last:pb-0">
                    ...
                    <p className="text-xs font-mono text-neutral-600 uppercase">{count}K</p>
                  </div>
                ))}
              </div>
              
              <div className="mt-8 text-center text-[10px] font-mono text-neutral-400 uppercase tracking-widest">
                 ✦ ✦ ✦
              </div>
            </div>
          </aside>
